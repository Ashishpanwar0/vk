    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 mb-16 md:mb-20">
            ...
            <div>
                ...
                <p class="text-gray-600 text-lg leading-relaxed mb-3"><?= esc($banquet['lavender']['description_1']) ?></p>
                <p class="text-gray-600 text-lg  leading-relaxed mb-3"><?= esc($banquet['lavender']['description_2']) ?></p>
                <p class="text-gray-600 text-lg  leading-relaxed mb-4"><?= esc($banquet['lavender']['description_3']) ?></p>
        ...
        <div class="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 mb-16 md:mb-20">
            <div class="order-2 lg:order-1">
                ...
                <div class="w-16 h-0.5 bg-[#C09130] my-4"></div>
                <p class="text-gray-600 text-lg leading-relaxed mb-3"><?= esc($banquet['orchid']['description_1']) ?></p> 
                <p class="text-gray-600 text-lg  leading-relaxed mb-3"><?= esc($banquet['orchid']['description_2']) ?></p>
