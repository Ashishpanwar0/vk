...
<section class="py-8 sm:py-12 md:py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 mb-16 md:mb-20">
            ...
            <div>
                <span class="uppercase tracking-[3px] text-[11px] text-[#C09130] font-semibold">Grand Banquet Hall</span>
                ...
                <p class="text-gray-600 text-sm md:text-base leading-relaxed mb-3"><?= esc($banquet['lavender']['description_1']) ?></p>
                <p class="text-gray-600 text-sm md:text-base leading-relaxed mb-3"><?= esc($banquet['lavender']['description_2']) ?></p>
                <p class="text-gray-600 text-sm md:text-base leading-relaxed mb-4"><?= esc($banquet['lavender']['description_3']) ?></p>
                <span class="inline-block bg-[#C09130] text-white px-6 py-2 rounded-full text-sm font-semibold"><?= esc($banquet['lavender']['price']) ?></span>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 mb-16 md:mb-20">
            <div class="order-2 lg:order-1">
                ...
                <div class="w-16 h-0.5 bg-[#C09130] my-4"></div>
                <p class="text-gray-600 text-sm md:text-base leading-relaxed mb-3"><?= esc($banquet['orchid']['description_1']) ?></p>
                <p class="text-gray-600 text-sm md:text-base leading-relaxed mb-3"><?= esc($banquet['orchid']['description_2']) ?></p>
                <p class="text-gray-600 text-sm md:text-base leading-relaxed mb-4"><?= esc($banquet['orchid']['description_3']) ?></p>
                <span class="inline-block bg-[#C09130] text-white px-6 py-2 rounded-full text-sm font-semibold"><?= esc($banquet['orchid']['price']) ?></span>
            </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
            ...
            <?php foreach ($banquet['lavender']['features'] as $feature): ?>
                <div class="flex items-center gap-2 bg-white p-3 sm:p-4 rounded-lg shadow-sm hover:shadow-md transition">
                    ...
                    <span class="text-gray-700 text-xs sm:text-sm"><?= esc($feature) ?></span>
                </div>
            <?php endforeach; ?>
            <!-- Orchid Features -->
